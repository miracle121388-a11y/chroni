...
当前版本提供“本地规则”和“用户自带 API Key”两种实际工作方式，尚未上线 Chroni 官方试用额度或官方 Relay。两种方式的适用范围、费用与安全边界见[模型使用方式](./docs/user/model-modes.md)。
...
- 当前没有官方免费模型额度；不开启模型时使用本地规则，启用模型时由用户自己的服务商账户承担费用。
